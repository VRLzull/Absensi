...
import { showError, showSuccess, showLoading } from '../utils/popup';
...
const Reports = () => {
  ...
  const exportToPDF = (fileName, options = { autoPrint: false }) => {
    try {
      ...
      if (employeeData.length > 0) {
        ...
        if (typeof doc.autoTable === 'function') {
          doc.autoTable({
            ...
            body: tableData,
            theme: 'grid',
            headStyles: { fillColor: [25, 118, 210], textColor: 255, fontStyle: 'bold', fontSize: 9 },
            margin: { left: margin, right: margin },
            styles: { fontSize: 8 },
          });
        } else {
      ...
      showError('Gagal membuat PDF', 'Pastikan jspdf-autotable terinstall dengan benar.');
    }
  };
